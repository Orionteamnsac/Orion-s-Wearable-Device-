...
#Ex = PhotoImage(file = 'orion.jpg')
Label(leftFrame).grid(row=2, column=0, padx=10, pady=2)
...
colorLog = Text(rightFrame, width = 50, height = 30, takefocus=0, highlightthickness=1, highlightbackground="#333")
colorLog.grid(row=10, column=0, padx=10, pady=2)
